  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (
        ...
        setError(
          `Network error — this is likely caused by FortiClient or another VPN/firewall blocking the connection to Supabase. Try fully quitting FortiClient (not just disconnecting) and restarting your dev server. Error: ${message}`,
        );
